        ...
        <Dialog as="div" className="relative z-10" onClose={setIsOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="font-[Comfortaa] relative flex flex-col lg:flex-row w-full text-white md:w-1/2 transform overflow-hidden bg-white text-left shadow-xl transition-all">
                  ...
                  <div className="bg-black p-10 flex flex-col justify-center">
                    ...
                    <div className="flex border-b border-gray-600 justify-center items-center py-5 text-xl">
                      <div className="text-center space-y-3">
                        <FaGift className="text-white w-24 h-24" />
                        <p>
                  ...
                  <div className="py-14 px-5 text-center mx-auto space-y-3 text-black">
                    ...
                    <OrderForm closeModal={setIsOpen} answers={[]} />

...
const Prices: React.FC = () => {
  ...
  return (
    <>
      ...
      <SEOWrapper
        title="Цены на ремонт и обслуживание кофемашин в Минске - coffeeremont24"
        description="Стоимость услуг по ремонту и обслуживанию кофемашин в Минске. Диагностика и выезд - бесплатно! Прайс-лист на сервисные работы и устранение неисправностей"
        link="https://www.coffeeremont24.by/prices/"
      >
        <Header />

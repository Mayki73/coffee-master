...
const Prices: React.FC = () => {
  ...
  return (
    <>
      ...
      <SEOWrapper
        title="Цены на ремонт и обслуживание кофемашин в сервисном центре в Минске"
        description="☕ Стоимость услуг по ремонту и обслуживанию кофемашин в Минске. ⭐ Диагностика и выезд - бесплатно! ⭐ Сервисные работы и устранение неисправностей"

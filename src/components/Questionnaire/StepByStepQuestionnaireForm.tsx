  ...
  return (
    <div>
      {step < formData.length ? (
        <div>
          <h2 className="text-2xl font-bold">{formData[step].question}</h2>
          <div
            className={clsx(
              "grid grid-cols-1 mt-8 max-w-[35rem] w-full gap-3",
              {
          ...
          >
            {formData[step].options.map((option, index) => (
              ...
              >
                <BiCheck className="mr-2 w-8 h-8 font-bold bg-gray-300 rounded-md p-2" />
        ...
        <div className="">
          <div className="flex flex-col justify-center items-center pb-10">
            <BiCheckCircle className="w-20 h-20 md:w-44 md:h-44 text-green-500" />

...
const Mulfunctions: React.FC = () => {
  ...
  return (
    <>
      ...
      <SEOWrapper
        title="Поломки и неисправности кофемашин"
        description="☕ CoffeeRemont24 предлагает профессиональные услуги по диагностике и ремонту кофемашин и кофеварок. ⭐ Диагностика и выезд - бесплатно! ⭐ Сервисные работы и устранение неисправностей"

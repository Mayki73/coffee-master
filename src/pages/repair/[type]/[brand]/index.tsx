...
export const getStaticPaths = (async () => {
  ...
  Brands["machines"].forEach((type) => {
    type.brands.forEach((brand) => {
      paths.push({ params: { type: type.type, brand: brand.name } });
    });
  });
  ...
  return {
    props: {
      brand: Brands["machines"]
        .find((brand) => brand.type === params?.type)
        ?.brands.find((brand) => brand.name === params?.brand),
    },
  };
}) satisfies GetStaticProps;

const BrandTemplate: React.FC<any> = ({ brand }) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                >
                  ...
                  <p>
                    ...
                    составляет 6 месяцев. Мы не являемся посредниками, имеем
                    достаточно опыта и уверены в качестве своей работы. Поэтому
                    можем гарантировать ее документально.
                  </p>
                </div>
                ...
                >
                  ...
                  <p>
                    ...
                    {(name ? name[0].toUpperCase() : "") + name?.slice(1)}: на
                    дому, в офисе, в кафе или ресторане.
                  </p>
                </div>
                ...
                >
                  ...
                  <p>
                    ...
                    {(name ? name[0].toUpperCase() : "") + name?.slice(1)} – мы
                    сделаем его всего за 2 часа с момента вашего обращения. Не
                    теряйте ни минуты – звоните!
                  </p>
                </div>
                ...
                >
                  ...
                  <ul className="space-y-5 list-disc list-inside">
                    <li key="original">
                      ...
                      {(name ? name[0].toUpperCase() : "") + name?.slice(1)} от
                      производителя у проверенных поставщиков
                    </li>
                    <li key="details">
                      Часто выходящие из строя детали{" "}
                      {(name ? name[0].toUpperCase() : "") + name?.slice(1)} уже
                      в наличии у мастера, поэтому ремонт занимает не более трех
                      часов.
                    </li>
                    <li key="chemistry">
                      Вы можете приобрести профессиональную химию для
                      обслуживания
                      {(name ? name[0].toUpperCase() : "") + name?.slice(1)} у
                      наших мастеров.
                    </li>
                  </ul>
                </div>

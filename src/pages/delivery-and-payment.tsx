  ...
  return (
    <>
      ...
      <main className="max-w-screen-2xl mx-5 md:mx-auto my-20 font-[Comfortaa] text-base md:text-lg leading-8 tracking-wider text-gray-600 font-light">
        ...
        <p className="mt-10">
          Мы стремимся обеспечить удобство и надежность в процессе ремонта вашей
          кофемашины. Мы понимаем, что доставка и оплата играют важную роль в
          вашем опыте обслуживания, поэтому предлагаем гибкие условия, чтобы
          сделать процесс максимально удобным для вас. Наша команда готова
          организовать безопасную доставку вашей кофемашины из и в удобное для
          вас место. Мы понимаем, что ваше устройство является важным
          компонентом вашей жизни, поэтому мы обеспечиваем аккуратную обработку
          и бережную перевозку, чтобы гарантировать сохранность вашей кофемашины
          во время доставки.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 mt-10 space-y-10 md:space-y-0">
          ...
          <p className="col-span-3">
            ...
            Менеджер согласует с вами время и день, когда курьер прибудет к вам.
            В зависимости от маршрута курьера, доставка может быть выполнена в
            тот же день или на следующий день после заказа. По завершении
            ремонта, мы свяжемся с вами для согласования времени доставки
            обратно. Все, что вам нужно сделать, это сообщить менеджеру о
            желании воспользоваться услугой доставки вашей кофемашины,
            предоставить адрес и мы сделаем все возможное, чтобы обеспечить вам
            удобство и комфорт в процессе обслуживания.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 mt-10 space-y-10 md:space-y-0">
          ...
          <ul className="col-span-3 list-disc list-inside space-y-5">
            ...
            <li>
              банковской картой (если мы производим доставку кофемашины, следует
              предупредить заранее о желании расплатится картой)
            </li>
            <li>
        ...
        <ul className="mt-10 list-decimal list-inside space-y-5">
          ...
          <li>
            Получив, Ваше согласие мы отремонтируем и проверим кофемашину. Если
            же откажетесь от ремонта, мы ее упакуем и отправим к вам той же
            транспортной компанией к вам домой.
          </li>
          <li>

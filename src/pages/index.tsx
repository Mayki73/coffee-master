...
const IndexPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <SEOWrapper
        title="Ремонт кофемашин и кофеварок в Минске, обслуживание на дому и сервисном центре"
        description="Срочный ремонт кофемашин и кофеварок Минске. ✅ Выезд мастера на дом или обслуживание кофемашины у нас в мастерской. ✅ Бесплатная диагностика. ✅ Гарантия. ☕ Сервисный центр CoffeeRemont24"
        link="https://www.coffeeremont24.by/"
      >
        <Header />
        <main className="font-sans mt-20 space-y-20 pb-20">
          <section
          ...
          <section className="w-full py-20 bg-gray-100">
            <div className="max-w-screen-2xl mx-5 md:mx-auto space-y-20">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-3 md:gap-y-16 gap-x-5 list-none list-inside">

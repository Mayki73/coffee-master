...
const About: React.FC = () => {
  return (
    <>
      <SEOWrapper
        title="О нас - Специалисты по ремонту кофемашин в Минске | CoffeeRemont24"
        description="Познакомьтесь с нашей командой опытных специалистов по ремонту кофемашин в Минске. Мы предлагаем профессиональные услуги по ремонту кофеоборудования, включая этапы от подачи заявки до окончательного ремонта. Узнайте больше о нашем опыте и качестве обслуживания."
        link="https://www.coffeeremont24.by/about/"
      >
        <Header />
        <main className="max-w-screen-2xl mx-5 md:mx-auto my-20 font-[Comfortaa] text-base md:text-lg leading-8 tracking-wider text-gray-600 font-light">
          ...
          <ScrollAnimate>
            <p className="mt-10">
              Наша компания работает более 5 лет, за это время мы наработали
              опыт по ремонту даже самых сложных неисправностей. Мы каждый день
              ...
              и даем на это гарантию 6 месяцев. У нас в штате 5 мастеров,
              которые выполняют плановые обслуживания и ремонты в офисах города
              Минска и Минской области. Сеть кофеен, которая угощает Вас кофе
              каждый день, наша работа.
            </p>
          </ScrollAnimate>

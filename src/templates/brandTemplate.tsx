            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                ...
                <p>
                  ...
                  {name[0].toUpperCase() + name.slice(1)} составляет 6 месяцев.
                  Мы не являемся посредниками, имеем достаточно опыта и уверены
                  в качестве своей работы. Поэтому можем гарантировать ее
                  документально.
                </p>
              </div>
              ...
              >
                ...
                <p>
                  Мы работаем с физическими и юридическими лицами, по наличному
                  и безналичному расчету. Принимаем к оплате карты: Visa, Master
